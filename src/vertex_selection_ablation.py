...
def classify_synthesis(
    ...
    # certification is evaluated separately on a score-bounded tuple hull.
    del n_violated, tol
...
def print_verification_protocol():
    ...
    print("  NOTE: hard certification requires the exact LMI conditions on the")
    print("        score-bounded tuple hull. A surrogate pass is not a hard")
    print("        certificate for the full adopted library.")
    print("=" * 80 + "\n")
